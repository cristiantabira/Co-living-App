...
router.get("/:complexId", protect, authorize("ADMIN", "GOD"), getComplexTickets);

// Assign ticket to an admin
router.patch("/:ticketId/assign", protect, authorize("ADMIN", "GOD"), assignTicket);

// Resolve ticket (mark as resolved)
router.patch("/:ticketId/resolve", protect, authorize("ADMIN", "GOD"), resolveTicket);

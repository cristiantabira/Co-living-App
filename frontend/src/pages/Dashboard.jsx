        ...
        <div>
            <header style={{ marginBottom: "32px" }}>
                ...
                <p style={{ color: "var(--text-muted)", marginTop: "8px" }}>
                    Iată situația financiară și task-urile apartamentului tău
                    pentru astăzi.
                </p>
            </header>
            ...
            >
                <div
                    style={cardStyle("var(--success)")}
                    onClick={() => navigate("/debts-details")}
                    style={{
                        ...cardStyle("var(--success)"),
                        cursor: "pointer",
                        transition: "transform 0.2s",
                    }}
                >
                    <p style={cardLabelStyle}>De recuperat</p>
                    <h2 style={cardValueStyle("var(--success)")}>
                        {balance.toReceive} RON
                    </h2>
                ...
                <div
                    style={cardStyle("var(--danger)")}
                    onClick={() => navigate("/debts-details")}
                    style={{
                        ...cardStyle("var(--danger)"),
                        cursor: "pointer",
                        transition: "transform 0.2s",
                    }}
                >
                    <p style={cardLabelStyle}>De plătit</p>
                    <h2 style={cardValueStyle("var(--danger)")}>
                        {balance.toPay} RON
                    </h2>
                    <small style={{ color: "var(--text-muted)" }}>
                        Click pentru detalii
                ...
                {tasks.length === 0 && (
                    ...
                    >
                        <p style={{ fontSize: "16px", margin: "0" }}>
                            Niciun task. Fă clic pe "+ Adaugă" pentru a crea
                            unul! 🎯
                        </p>
                    </div>
                )}
